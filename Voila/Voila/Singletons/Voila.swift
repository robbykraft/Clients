...
//				project.proposalSent = Int(Date().timeIntervalSince1970)
	...
	var pageHeader = "<!DOCTYPE html><html><body style=\"background-color: #EEE; padding:2em; font-size:.4em;\"><div style=\"background-color: #FFF; padding:2em;\"><div id=\"custom-note-section\" style=\"text-align:left\"><p>&nbsp;</p></div><div style=\"text-align:center\"><img style=\"max-width:100%\" src=\"https://firebasestorage.googleapis.com/v0/b/voila-a01f0.appspot.com/o/logo.png?alt=media&token=b84934bf-2584-48e5-9e9c-900c24b782d3\"></div><div style=\"text-align:center\"><p style=\"color:#888;font-size: 1.3em;\">" +
